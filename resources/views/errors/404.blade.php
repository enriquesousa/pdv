...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">Pagina No Encontrada </h3>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Regresar a <a href="{{ route('dashboard') }}" class="text-white ms-1"><b>Inicio</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; Punto de Venta Fácil por <a href="">EsWeb</a> 
        </footer>
