                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mt-3 text-center">
                                ...
                                <p class="text-muted font-14 mt-2"> Por ser la primera vez que registras este coreo,  antes de comenzar, se te enviara un correo electrónico de <b>verificación</b>. ¿Podría verificar tu dirección de correo electrónico haciendo clic en el enlace que le acabamos de enviar por correo electrónico? Si no recibiste el correo electrónico, con gusto le enviaremos otro..
                                </p>
                                ...
                                <a href="{{ route('home') }}"
                                    class="btn w-100 btn-pink waves-effect waves-light mt-3">Regresar a Inicio</a>
