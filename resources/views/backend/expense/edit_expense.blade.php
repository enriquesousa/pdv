                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="fecha" class="form-control" value="{{ $expense->date }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="details" class="form-control" id="example-textarea" rows="3" required>{{ $expense->details }}</textarea>
                                            </div>
                                        </div>
