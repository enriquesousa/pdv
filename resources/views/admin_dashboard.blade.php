                    ...
                    <div class="tab-pane active" id="settings-tab" role="tabpanel">
                        ...
                        <div class="p-3">
                            <div class="alert alert-warning" role="alert">
                                <strong>Personaliza </strong> el tema de tu aplicación web, esquema de color, sidebar menu, etc.
                            </div>
                            ...
                            <div class="form-check form-switch mb-1">
                                <input type="checkbox" class="form-check-input" name="leftbar-size" value="condensed"
                                    id="condensed-check" />
                                <label class="form-check-label" for="condensed-check">Condensado <small>(Extra Pequeño)</small></label>
                            </div>
